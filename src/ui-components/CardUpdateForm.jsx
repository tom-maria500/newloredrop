...
export default function CardUpdateForm(props) {
  ...
  const [flipped, setFlipped] = React.useState(initialValues.flipped);
  ...
  const resetStateValues = () => {
    ...
    setFlipped(cleanValues.flipped);
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getCard.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getCard
        : cardModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateCard.replaceAll("__typename", ""),
            variables: {
              input: {
                id: cardRecord.id,
                ...modelFields,
      ...
      <SwitchField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.flipped ?? value;
          }
          if (errors.flipped?.hasError) {
            runValidationTasks("flipped", value);
          }
          setFlipped(value);
        }}
        onBlur={() => runValidationTasks("flipped", flipped)}
        errorMessage={errors.flipped?.errorMessage}
        hasError={errors.flipped?.hasError}
        {...getOverrideProps(overrides, "flipped")}
      ></SwitchField>
      <TextField
        label="Created at"
        isRequired={false}
